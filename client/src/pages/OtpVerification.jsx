...
const OtpVerification = () => {
    ...
    useEffect(()=>{   // like a middleware if the user not enter the email he not come to the email verification router.
    ...
    const handleSubmit = async(e)=>{
        ...
        try {
            ...
            if(response.data.success){  // if show the success message then
